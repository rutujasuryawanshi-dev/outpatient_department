            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                      itemCount: systemNotificationsList['Unread notifications']!.length,
                      itemBuilder: (BuildContext context, int index) {
                        return Padding(
                          padding: const EdgeInsets.only(
                              ...
                              Flexible(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                                systemNotificationsList['Unread notifications']![index]["time"]!,
                                                style: TextStyle(
                                                    color: ArgonColors.muted)),
                                          ],
                                        )
                                    ...
                                    Text(
                                        systemNotificationsList['Unread notifications']![index]["description"]!,
                                        style: TextStyle(
                                            color: ArgonColors.text,
                                            fontWeight: FontWeight.w600))
                                  ],
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          flex: 2,
                                          child: Text(
                                              systemNotificationsList['Read notifications']![index]["title"]!,
                                              style: TextStyle(
                                                  color: ArgonColors.muted,
                                                  fontWeight: FontWeight.w400)),
                                        ),
