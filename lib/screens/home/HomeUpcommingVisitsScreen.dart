...
class HomeUpcommingVisitsScreen extends StatefulWidget {
  const HomeUpcommingVisitsScreen({super.key});

  @override
  State<HomeUpcommingVisitsScreen> createState() => _HomeUpcommingVisitState();
}

class _HomeUpcommingVisitState extends State<HomeUpcommingVisitsScreen> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  bool isAnimated = false;
  TextEditingController _searchController = TextEditingController();
  List<Appointments>? appointmentList = [];
  bool isUpcommingAppointmentListNotEmpty=false;
  ...
  Future<void> _getUpcommingAppointments() async {
        ...
        if (response != null) {
          ...
          if (appointments.sCode == 200) {
            ...
            if (appointmentList!.length != 0){
              setState(() {
                isUpcommingAppointmentListNotEmpty=true;
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        isUpcommingAppointmentListNotEmpty ? Positioned(
